...
# datarium is a library of database
...
#Btw X variables : no shape beacause no correlation
...
#The first part is to create the regression model, and the second part is to verify if our model is good or not
...
#Package that give us the possibility to measure the importance of each variable
...
# Pseudo-R2: how well the fitted model explains the data as compared 
# to the default model of no predictor variables and only an intercept term; 
# values closer to one indicating that the model has good predictive power
