...
# Combine the var 2 by 2 
# geom_point = add aditionnal component you want (here, the centers with the big dots)
...
#group 2 : Average recency, average frcy, not too big monetary
# permet de caractérisé une nouvelle personne si elle rentre en base pr la cibler correctement 

#group 3 : low recency, high frequency, high monetary
