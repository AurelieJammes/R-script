...
# support = pourcentage d'apparition
# count = nombre d'apparition
...
# lift = relation entre support et confidence : plus le support va etre haut et le confidence va être bas et plus le lift va etre haut
